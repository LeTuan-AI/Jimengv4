                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="flex items-center bg-luxury-purple border border-white/10 rounded-2xl overflow-hidden focus-within:ring-2 focus-within:ring-luxury-gold/40 focus-within:border-luxury-gold transition-all h-[52px] px-4">
                        <input 
                          type="number"
                          value={numEpisodes || ''}
                          onChange={(e) => {
                          ...
                          className="flex-1 bg-transparent border-none text-left focus:ring-0 p-0 text-white font-bold text-sm min-w-0"
                        />
                        <div className="flex items-center gap-1 ml-2">
                          <button 
                            onClick={() => setNumEpisodes(Math.max(1, numEpisodes - 1))}
                            className="p-2 bg-white/5 hover:bg-white/10 rounded-lg text-luxury-gold/60 hover:text-luxury-gold transition-all active:scale-90"
                            type="button"
                          >
                      ...
                      <div key={ep.id} className="bg-luxury-purple-light/40 border border-white/10 rounded-3xl p-8 hover:border-luxury-gold/40 transition-all group">
                        <div className="flex flex-col md:flex-row gap-8">
                          ...
                          <div className="md:w-48 flex flex-col justify-between items-end">
                            <div className="flex items-center gap-2 bg-luxury-purple-dark/60 px-3 py-2 rounded-xl border border-white/10">
                              ...
                              <input 
                                ...
                                className="bg-transparent border-none text-xs font-black text-luxury-gold focus:ring-0 p-0 w-6 text-left min-w-0"
                              />
                              <div className="flex items-center gap-1">
                                <button 
                                  onClick={() => updateEpisode(ep.id, 'duration', Math.max(1, ep.duration - 1))}
                                  className="p-1 hover:bg-white/5 rounded text-luxury-gold/60 hover:text-luxury-gold transition-all active:scale-90"
                                  type="button"
                                >
